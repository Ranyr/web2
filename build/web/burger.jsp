...
document.myfm.submit();
   ...
   <tr><td><i><input type="text" name="s1" value="Crispy Veg burger" readonly="readonly"></i></td>
       <td><input type="text"  name="t1" value="35" size="3" readonly="readonly"></td>
           <td><input type="button" name="button1" value= "go" onClick=submitForm(this) /> </tr>
   
            <tr><td><i><input type="text" name="s2" value="Crispy Chicken" readonly="readonly"></i></td>
                <td><input type="text" name="t2" value="49" size="3" readonly="readonly"></td>
