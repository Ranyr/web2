...
<tr><td><i><input type="text" name="s1" value="Gazar Halwa(kg)"></i></td>
    <td><input type="text"  name="t1" size="3" value="150"></td><td><input type="button" name="button1" value= "go" onClick=submitForm(this) /></td></tr>
    ...
    <tr><td><i><input type="text" name="s4" value="Ice Cream"></i></td>
        <td><input type="text"  name="t4" size="3" value="35"></td><td><input type="button" name="button4" value= "go" onClick=submitForm(this) /></td></tr>
            
        <tr><td><i><input type="text" name="s5" value="Chocolate cake"></i></td>
            <td><input type="text"  name="t5" size="3" value="350"></td><td><input type="button" name="button5" value= "go" onClick=submitForm(this) /></td></tr>
