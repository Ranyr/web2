...
public class admincheck extends HttpServlet {
   ...
   if(count>0){
       RequestDispatcher dis=request.getRequestDispatcher("index.jsp");//now  call goes to success1
   ...
   out.println("<h1><b><center><font color='red'>no such user found please sign up first</center><b></h1>");
                 out.println("<h2><center>OR</center></h2>");
       out.println("<h3><b><center><font color='red'><a href='admin.jsp'>try again with correct credentials</a></center><b></h3>");
