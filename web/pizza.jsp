...
document.myfm.submit();
   ...
   <tr><td><i><input type="text" name="s1" value="Plain Cheese" readonly="readonly"></i></td>
       <td><input type="text"  name="t1" size="4" value="210" readonly="readonly"></td>
      
           <td> <input type="button" name="button1" value= "go" onClick=submitForm(this) /> </td> </tr>
          
   
   <tr><td><i><input type="text" name="s2" value="Spicy Delight" readonly="readonly"></i></td>
       <td><input type="text"  name="t2" size="4" value="130" readonly="readonly"></td>
